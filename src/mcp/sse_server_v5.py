#!/usr/bin/env python3
"""
Dr. Strunz Knowledge Base MCP Server - Version 5.0
Using FastMCP run() method directly for proper SSE support
"""
...
mcp = FastMCP(
    name="Dr. Strunz Knowledge Server v5.0",
...
if __name__ == "__main__":
    # Run the server directly using FastMCP's run method
    # This is the proper way to run SSE servers
    port = int(os.environ.get("PORT", 8080))
    logger.info(f"Starting Dr. Strunz Knowledge MCP Server v5.0 on port {port}")
